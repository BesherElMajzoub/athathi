...
<div class="floating-buttons">
    <a href="{{ config('business.whatsapp_url') }}" class="floating-btn floating-whatsapp" target="_blank" rel="noopener"
        aria-label="تواصل عبر واتساب" data-track="floating-whatsapp">
    ...
    <a href="tel:{{ config('business.phone') }}" class="floating-btn floating-call" aria-label="اتصل بنا"
        data-track="floating-call">
        <svg viewBox="0 0 24 24" width="28" height="28" fill="white">
            <path
